...
##donees IPR
data_net<-readRDS("donnees entree/data_net_complet")#table de donnes aspe pour la création des cartes et donut
tend_nat<-readRDS("donnees entree/tend_nat")#table de donnees tendance national ipr
data_tendance<-readRDS("donnees entree/data_tendance")#table de donnees pour dresser les tendances national

##donnes IBD
IBD_net<-readRDS("donnees entree/IBD_net22")# table de donnees ibd pour la construction des map et diagramme par annee
IBD_per<-readRDS("donnees entree/IBD_per")#table pour construire les diagramme en barre par periode
AG<-readRDS("donnees entree/tendance_bv")#table de donnees tendance par bv  ibd
t_ssbv<-readRDS("donnees entree/t_ssbv")#table de donnees tendance par ssbv  ibd
t_nat<-readRDS("donnees entree/t_nat")#tabe de donnees tendance national ibd
tendance_IBD<-readRDS("donnees entree/tendance_IBD")

tauxbv<-readRDS("donnees entree/tableaubv")
tauxssbvb<-readRDS("donnees entree/tableau_ssbv_ibd")
tauxbvb<-readRDS("donnees entree/tableau_bv_bis_ibd")
tauxssbv<-readRDS("donnees entree/tableau_ssbv")
...
bv_tend<-readRDS("donnees entree/bv_tend")
ssbv_tend<-readRDS("donnees entree/ssbv_tend")
...
tend_ssbv<-readRDS("donnees entree/tend_ssbv")
periode<-readRDS("donnees entree/periode")
periode

# # Les questions réparties en thématiques

Region<-readRDS("donnees entree/Region")
Departement<-readRDS("donnees entree/Departement")
Ssbv<-readRDS("donnees entree/Ssbv")
# qualite<-readRDS("qualite")
bv<-readRDS("donnees entree/BV")
cd<-readRDS("donnees entree/cd")
leg<-readRDS("donnees entree/leg")
color<-readRDS("donnees entree/color")
BV<-readRDS("donnees entree/bvv")
CD<-readRDS("donnees entree/cdb")
year<-2010:2020
years<-2010:2020
           ...
           column(6,
                  ...
                  fluidRow(
                    column(12, align ="center",style="background-color:#d1dad8;border-radius: 10px;",
                           ...
                           p("Cet outil a été élaboré à partir du logiciel R version 4.0.3 (2020-10-10).  Le script, accessible depuis la plateforme GitHub, est disponible sur ",a("https://github.com/loub-ch/Dataviz",href="https://github.com/loub-ch/Dataviz", target="_blank"),".",style="text-align:justify;color:black;padding-left:15px"),
                    ),
                  ),
                  br(),
                  fluidRow(
